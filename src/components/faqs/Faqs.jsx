    ...
    const faqsData =[
      {
        ...
        { "id": 2, "question": "Why should I choose Loadkaro for transport service?",
          "answer":`Loadkaro is known for presenting the customers with safe, 
          convenient and goods transportation service in India. We help the clients to manage
           all your daily transport-related issues through the truck booking services.
            ...
            Now searching for the best transporters in your city would be easy as Loadkaro is all set to serve the
             customers with 
        ...
        { "id": 3, "question":"What type of Services does Loadkaro provide?",
          "answer":`Loadkaro provides services in full Truck and a part load truck
           for business and personal requirement. We have come up with an exclusive
            platform for the customers to get a trouble-free and affordable movement
             of consignments to different locations around the nation. From business
              to personal goods movement, Loadkaro provides the lowest prices for movement
        ...
        { "id": 4, "question": "How can I insure my goods during the trip?",
          "answer":`
          Loadkaro provides the simplest way of booking transportation on the cheapest rates with quality services. You do not need to pay anything while booking, partial or full payment can be made at the time of loading and the remaining amount can be paid at the time of unloading. The multiple modes of payment facility help the users in making secure transactions through the system.
All on-line payments made towards availing Services shall be taken into consideration only when the relevant amount is received and credited in the Company's bank account. The User booking for the Service shall pay all amounts including the fare, parking charges, additional night surcharge if applicable and any fee or levy presently payable or hereinafter imposed by the law or required to be paid for availing of the Services.
        ...
        { "id": 5, "question": "How can I insure my goods during the trip?" ,
          "answer":`Loadkaro provides insurance services for securing and ensuring the safe movement of the material and the goods. You can avail the insurance services by contacting the customer services whiling booking a trip. You can now keep your goods secured through insurance at very low price.
      ...
      <div className={props.usecontainer}>
        <div className={`faqsinner ${props.rightLeftdir}`}>
          ...
          <div className='section-header'>
            <h4>
              &lt;H2&gt; lets get information from
            </h4>
            <h2>
              Frequently Ask Questions
            </h2>
            <p>
              Lorem ipsum dolor sit ame. Duis aute irure dolor in reprehenderit in 
              voluptate velitesse non provident Lorem olor sit ame. Duis aute irure dolor 
          ...
          <div className='pre_img'>
            <img src={IMAGES.faqsBanner} alt="banner" />
          </div>
        </div>
      </div>
    </div>
